...
import { testing, testing2, testing3, testing4, testing5, testing6, testing7, testing8, testing9 } from '../src/controllers/test.controller'
...
describe('TEST', ()=>{
    ...
    it('SHOULD RETURN 9 TRUE', ()=>{
        expect(testing9()).to.equal(true)
    })
})